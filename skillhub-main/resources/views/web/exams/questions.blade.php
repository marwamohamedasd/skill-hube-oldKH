...
@endforeach
                ...
                <div>
                    <button class="main-button icon-button pull-left" form="exam-submit-form">Submit</button>
            ...
            <!-- /main blog -->
               ...
               <div id="aside" class="col-md-3">
                ...
                <div class="duration-countdown" data-timer="25"></div>
...
<script type="text/javascript" src="{{asset('web/js/TimeCircles.js')}}">


</script>
<script>

$(".duration-countdown").TimeCircles({time:{
    Days:{
        show:false
    }
},
