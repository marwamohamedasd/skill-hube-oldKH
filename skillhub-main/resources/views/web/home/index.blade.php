		...
		<div id="home" class="hero-area">
			...
			<div class="home-wrapper">
				<div class="container">
					<div class="row">
						<div class="col-md-8">
							<h1 class="white-text">@lang('web.test-skill')</h1>
							<p class="lead white-text">@lang('web.sign-test-youskills')</p>
							<a class="main-button icon-button" href="{{url('skills')}}">@lang('web.start')</a>
						</div>
					</div>
				</div>
			</div>
